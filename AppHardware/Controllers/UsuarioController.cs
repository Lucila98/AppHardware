...
namespace AppHardware.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsuarioId,Nombre,Apellido, isIT")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsuarioId,Nombre,Apellido, isIT")] Usuario usuario)
        {
